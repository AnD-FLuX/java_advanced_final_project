...
<div class="w3-sidebar w3-bar-block w3-dark-gray" style="width:220px">
 ...
 <a href="/entrantAccount" class="w3-bar-item w3-button w3-hover-red w3-cursive"> <i class="far fa-address-card"></i>  Account</a>
  ...
  <sec:authorize access="hasRole('ROLE_ENTRANT')">
  <a href="/myApplications" class="w3-bar-item w3-button w3-green w3-hover-green w3-cursive"><i class="fas fa-outdent"></i>  My Applications</a>
			...
			<thead>
				...
				<c:forEach items="${facultyRegistrations}" var="currentRegistration">
					<tr>
						...
						<td><a href="${contextPath}/myApplications/delete/${currentRegistration.id}" 
										class="w3-btn w3-hover-red w3-green w3-margin-bottom"><i class="far fa-trash-alt"></i></a></td>
					</tr>
