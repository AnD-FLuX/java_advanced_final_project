...
<!--Content -->
					...
					<div class="w3-container w3-red w3-margin w3-card-4">
  						<h2><spring:message code='EntrantAccount'/>:</h2>
						</div>
    ...
    <div class="w3-container w3-card-4 w3-light-grey" style="width:800px; padding:25px">
        ...
        <div class="w3-half" >
          ...
          <br>
            ...
            <label class=""><spring:message code='city'/>:</label>
            <h3 class="">${entrantInfo.city}</h3>

            <label class=""><spring:message code='school'/>:</label>
            <h3 class="">${entrantInfo.school}</h3>
            
            <label class=""><spring:message code='averCert'/>:</label>
            <h3 class="">${entrantInfo.certificatAvarageMark}</h3>
