...
<!--Content -->
					...
					<div class="w3-container w3-red w3-margin w3-card-4">
  						<h2><spring:message code='UserAccount'/>:</h2>
						</div>
...
<div class="w3-container">
    ...
    <div class="w3-display-container w3-card-4 w3-light-grey" style="height:400px;width:800px; padding:25px">
        ...
        <button style="margin:18px" onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-red "><i class="far fa-edit"></i> <spring:message code='add'/>  </button>
    </div>
        <div class="w3-half" >
            <h2 class="">${userInfo.firstName}  ${userInfo.lastName}</h2>
            <br>
            <label class=""><spring:message code='email'/>:</label>
        ...
        <div id="id01" class="w3-modal w3-animate-opacity">
          <div class="w3-modal-content w3-card-4">
            ...
            <div class="w3-container">
                ...
                <br>
                <label for="city"><spring:message code='city'/>:</label><br>
                <input class="w3-input w3-border" name="city" required placeholder="Enter your city..."/>
                <br>
                <label for="school"><spring:message code='school'/>:</label><br>
                <input class="w3-input w3-border" name="school" type="text" required placeholder="Enter your school..."/>
                <br>
                <label for="school"><spring:message code='averCert'/>:</label><br>
                <input class="w3-input w3-border" name="certificatAvarageMark" type="number" required placeholder="Enter your Average grade of the certificate..."/>
                <br>
                <label for="school"><spring:message code='Photo'/>:</label><br>
            ...
            <footer class="w3-container ">
 			 ...
 			 <div class="w3-tag w3-round w3-red" style="padding:3px">
   			 	<div class="w3-tag w3-round w3-red w3-border w3-border-white">
   			   			 <i class="fas fa-exclamation-triangle"></i>  <spring:message code='submitLogout'/>  <i class="fas fa-exclamation-triangle"></i>    
   			   </div>
 			</div>

                       
            <br>
                <input class="w3-button w3-green w3-margin w3-center" type="submit"  value="<spring:message code='submit'/>"></input>
               <br>
